...
// Source: github.com/yagoernandes/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddBalance(arg0 context.Context, arg1 db.AddBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.CreateTransferParams) (db.TransferResult, error) {
	m.ctrl.T.Helper()
